                        ...
                        <div className='pt-10 sticky top-0'>
                            ...
                            <div className='pt-7'>
                                {trendingPost.map((item, index) => {
                                    return (
                                        <div key={index}>
                                            <Card image={item.img} title={item.title} buttonTitle={item.btnTitle} seccolor={''} fontweight={'600'} display={''} visible={''} gap={''} alignItems={''} title2={''} secFontweight={''} secFontSize={''} show={''} imgMaxHeight={''} width={''} outerImg={''} minHeight={''} speed={undefined} />
                                        </div>
                                    )
                                })}
                            </div>
