                                ...
                                <div key={index}>
                                    <div className='flex max-w-full py-7 items-center  justify-between gap-20 border-b-[1px] border-b-black'>
                                        <span className=' text-[20px] sm:text-2xl'>
                                            <Card image={item.img} title={item.title} buttonTitle={''} seccolor={''} fontweight={'600'} display={'flex'} visible='none' gap={'20px'} alignItems={'center'} title2={''} secFontweight={''} secFontSize={''} show={''} imgMaxHeight={''} width={''} outerImg={'200px'} minHeight={''} speed={undefined} />
                                        </span>
                                ...
                                return (
                                    <div key={index}>
                                        <div className='py-4 border-b-[1px] border-b-black pt-5 sm:pt-10'>
                                            <Card image={item.img} title={item.title} buttonTitle={'AUTOMOTIVE'} seccolor={''} fontweight={'700'} display={''} visible={''} gap={''} alignItems={''} title2={''} secFontweight={''} secFontSize={''} show={''} width={''} imgMaxHeight={'200px'} outerImg={''} minHeight={''} speed={undefined} />
                                        </div>
                                    </div>
                                )
                            })}
