                            ...
                            return (
                                <div key={index}>
                                    <div className='pt-5 pb-10 sm:pb-20 card'>
                                        <Card image={item.img} title={item.title} buttonTitle={item.buttonTitle} seccolor={''} fontweight={'600'} display={'flex'} visible={''} gap={'20px'} alignItems={''} title2={item.subTitle} secFontweight={''} secFontSize={'16px'} show={''} imgMaxHeight={''} width={''} outerImg={''} minHeight={''} speed={undefined}/>
                                    </div>
                                </div>
                            )
                        })}
